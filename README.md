...
Railway builds the repository `Dockerfile`; Next.js emits a standalone server and Railway injects `PORT`. See [DEPLOYMENT.md](DEPLOYMENT.md), [RAILWAY.md](RAILWAY.md), [ENVIRONMENT.md](ENVIRONMENT.md), and [SUPABASE.md](SUPABASE.md).
