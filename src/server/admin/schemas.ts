...
export const adminMediaAssetSchema = z
  .object({
    ...
    focal_x: z.coerce.number().min(0).max(100).optional(),
    focal_y: z.coerce.number().min(0).max(100).optional(),
    ...
    component_key: z.string().nullable().optional(),
    locale: z.string().nullable().optional(),
    breakpoint: z.string().optional(),
    variant: z.string().nullable().optional(),
    original_filename: z.string().nullable().optional(),
    generated_filename: z.string().nullable().optional(),
